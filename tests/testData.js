...
tD.meditate = new Move('Meditate', 'Psychic', 20, 0, 'N/A', 'Status')
tD.defenseCurl = new Move('Defense Curl', 'Normal', 20, 0, 'N/A', 'Status')
tD.growth = new Move('Growth', 'Normal', 20, 0, 'N/A', 'Status')
tD.charge = new Move('Charge', 'Electric', 20, 0, 'N/A', 'Status')
tD.confide = new Move('Confide', 'Normal', 20, 0, 'N/A', 'Status')
tD.leer = new Move('Leer', 'Normal', 20, 0, 'N/A', 'Status')
tD.swordsDance = new Move('Swords Dance', 'Normal', 20, 0, 'N/A', 'Status')
tD.amnesia = new Move('Amnesia', 'Normal', 20, 0, 'N/A', 'Status')
tD.cosmicPower = new Move('Cosmic Power', 'Psychic', 20, 0, 'N/A', 'Status')
tD.workUp = new Move('Work Up', 'Normal', 20, 0, 'N/A', 'Status')
tD.charm = new Move('Charm', 'Normal', 20, 0, 'N/A', 'Status')
tD.tearfulLook = new Move('Tearful Look', 'Normal', 20, 0, 'N/A', 'Status')
tD.powerUpPunch = new Move('Power Up Punch', 'Fighting', 20, 40, 100, 'Status')
tD.metalClaw = new Move('Metal Claw', 'Steel', 20, 50, 95, 'Physical')
tD.crushClaw = new Move('Crush Claw', 'Normal', 20, 75, 95, 'Physical')
tD.ancientPower = new Move('Ancient Power', 'Rock', 5, 60, 100, 'Special')
tD.haze = new Move('Haze', 'Ice', 20, 0, 'N/A', 'Status')
tD.psybeam = new Move('Psybeam', 'Psychic', 20, 65, 100, 'Special')
tD.flash = new Move('Flash', 'Normal', 20, 0, 'N/A', 'Status')
tD.doubleTeam = new Move('Double Team', 'Normal', 20, 0, 'N/A', 'Status')
tD.sweetScent = new Move('Sweet Scent', 'Normal', 20, 0, 'N/A', 'Status')
tD.honeClaws = new Move('Hone Claws', 'Normal', 20, 0, 'N/A', 'Status')
